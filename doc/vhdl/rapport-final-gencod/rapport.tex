...
% L'organisation du compilateur est d\'ecrite dans la
% figure~\ref{comp-organisation}. L'organisation de l'\'etape de
% g\'en\'eration de code s\'equentiel \`a partir de code data-flow
% est donn\'ee dans la figure~\ref{translation}.
% Ce compilateur est \'ecrit en Ocaml.

% \begin{figure}
% \begin{center}
% %\rotatebox{-90}
% {\includegraphics[height=3cm]{Fig/comp-organisation}}
% \end{center}
% \caption{Organisation du compilateur\label{comp-organisation}}
% \end{figure}

% \begin{figure}
% \begin{center}
% \rotatebox{-90}{\includegraphics[height=11.5cm]{Fig/translation}}
% \end{center}
% \caption{Traduction vers du code imp\'eratif\label{translation}}
% \end{figure}
